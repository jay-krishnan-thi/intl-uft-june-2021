...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/"" xmlns:p1=""http://www.w3.org/2001/XMLSchema-instance""><Body><CreateFlightOrder xmlns=""HP.SOAQ.SampleApp""><FlightOrder><Class>Business</Class><CustomerName>Bob</CustomerName><DepartureDate>{Step.InputProperties.StServiceCallActivity4.Body.GetFlights.FlightDate}</DepartureDate><FlightNumber>{Step.OutputProperties.StServiceCallActivity4.Body.GetFlightsResponse.GetFlightsResult.Flight[1].FlightNumber}</FlightNumber><NumberOfTickets>5</NumberOfTickets></FlightOrder></CreateFlightOrder></Body></Envelope>");
            ...
            VTDBaseGetter binding_getter11 = new VTDXPathGetter(pi19,XmlTypeCode.Int);
            ...
            VTDBaseSetter binding_setter9 = new VTDXPathSetter(pi20,XmlTypeCode.Int);
            bind_dir9 = new BindDirection(_flow.StServiceCallActivity4,binding_getter11,binding_setter9,BindTargetType.ToInProperty);
            ...
            VTDBaseGetter binding_getter12 = new VTDXPathGetter(pi21,XmlTypeCode.DateTime);
            ...
            VTDBaseSetter binding_setter10 = new VTDXPathSetter(pi22,XmlTypeCode.DateTime);
            bind_dir10 = new BindDirection(_flow.StServiceCallActivity4,binding_getter12,binding_setter10,BindTargetType.ToInProperty);
